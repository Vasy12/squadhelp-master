    ...
    <div className={styles.signUpPage}>
      <div className={styles.signUpContainer}>
        <div className={styles.headerSignUpPage}>
          <LogoLink src={`${CONSTANTS.STATIC_IMAGES_PATH}logo.png`}/>
      ...
      <div className={styles.footer}>
        <div className={styles.articlesMainContainer}>
          <div className={styles.ColumnContainer}>
            <div className={styles.headerArticle}>Why should I use Squadhelp?
            </div>
            ...
            <div className={styles.headerArticle}>How is Squadhelp Different?
            </div>
            <div className={styles.article}>
          ...
          <div className={styles.ColumnContainer}>
            ...
            <div className={styles.headerArticle}>Do you offer any discount for
              multiple contests?
            </div>
            <div className={styles.article}>
            ...
            <div className={styles.article}>
              ...
              send us a <span
              className={styles.orangeSpan}>message</span>. For assistance with
              launching a contest,
